...
export const musicPlayerSlice = createSlice({
    ...
    reducers: {
        ...
        setPlaylistsData: (state, action: PayloadAction<any>) => {
...
export const selectPlaylistsData = (state: RootState) => state.musicPlayer.playlistsData;
export const selectPlaylistLoading = (state: RootState) => state.musicPlayer.playlistsLoading;
export const selectPlaylistError = (state: RootState) => state.musicPlayer.playlistsError;
