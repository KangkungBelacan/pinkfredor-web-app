...
function UserAccount() {
    ...
    return (
            <div className="user-content-container">
                ...
                <div>
                    <h1 className="Text" style={{margin:"10px"}}>Account Settings</h1>
                    <h2 className="Text" style={{margin:"10px"}}>Personal Information</h2>
                    <div className="flex">
                    ...
                    <br/><h2 className="Text" style={{margin:"10px"}}>Number Given In Store</h2>
                    <div className="flex">
                        <div style={{margin:"10px"}}>
                            <label className="Label" htmlFor="PhoneNum">Phone Number <a className="LinkText" href={"/help"}>ⓘ</a></label><br/>
